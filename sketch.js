...
function preload() {
  ...
  lucarioShurikenImg = loadAnimation("lucarioShuriken.png");
  lucarioShurikenLeftImg = loadAnimation("lucarioShurikenLeft.png");
  ...
  greninjaShurikenImg = loadAnimation("greninjaShuriken.png");
}
function setup() {
  ...
  lucarioShuriken = createSprite(0, 0);
  lucarioShuriken.addAnimation("shuriken", lucarioShurikenImg);
  lucarioShuriken.scale = 0.10;
  lucarioShuriken.visible = false;

  lucarioShurikenLeft = createSprite(0, 0);
  lucarioShurikenLeft.addAnimation("shuriken", lucarioShurikenLeftImg);
  lucarioShurikenLeft.scale = 0.10;
  lucarioShurikenLeft.visible = false;

  greninjaShuriken = createSprite(0, 0);
  greninjaShuriken.addAnimation("shuriken2", greninjaShurikenImg);
  greninjaShuriken.scale = 0.10;
  greninjaShuriken.visible = false;
}
...
function draw() {
  ...
  if (gameState === "play") {
    ...
    if (player2.x <= 590 && keyDown('n') && player2.y >= 220 && player2.x >= 335) {
      player2.velocityY = -12;
    } else if (keyDown('n') && player2.y >= 105 && player2.x <= 1160 && player2.x >= 590) {
      player2.velocityY = -12;
    } else if (player2.x >= 875 && keyDown('n') && player2.y >= 220 && player2.x <= 1420) {
      player2.velocityY = -12;
    }
    ...
    if (keyDown("r") && lucarioShuriken.visible === false && player2.x > player1.x && basic1 > 15) {
      player1.changeAnimation("rangedRight", lucarioAttack);
      player1.scale = 0.40;
      basic1 = 0;
      lucarioShuriken.x = player1.x;
      lucarioShuriken.y = player1.y;
      lucarioShuriken.visible = true;
      lucarioShuriken.velocityX = 12;
    }
    if (keyDown("f") && lucarioShurikenLeft.visible === false && player2.x < player1.x && basic1 > 15) {
      player1.changeAnimation("rangedLeft", lucarioRangedLeft);
      player1.scale = 0.40;
      basic1 = 0;
      lucarioShurikenLeft.x = player1.x;
      lucarioShurikenLeft.y = player1.y;
      lucarioShurikenLeft.visible = true;
      lucarioShurikenLeft.velocityX = -12;
    }
    if (lucarioShuriken.x > 1750) {
      lucarioShuriken.visible = false;
    }
    if (lucarioShurikenLeft.x < 0) {
      lucarioShurikenLeft.visible = false;
    }
    if (lucarioShuriken.isTouching(player2) && player1.x < player2.x) {
      player2Health = player2Health - 10;
      player2.x = player2.x + 8;
      lucarioShuriken.visible = false;
      lucarioShuriken.x = 0;
      lucarioShuriken.y = 0;
    } else if (lucarioShurikenLeft.isTouching(player2) && player1.x > player2.x) {
      player2Health = player2Health - 10;
      player2.x = player2.x - 8;
      lucarioShurikenLeft.visible = false;
      lucarioShurikenLeft.x = 0;
      lucarioShurikenLeft.y = 0;
    }
    ...
    if (keyDown("y") && greninjaShuriken.visible === false && player1.x > player2.x && basic2 > 15) {
      player2.changeAnimation("rangedRight", greninjaRangedRight);
      player2.scale = 0.06;
      basic2 = 0;
      greninjaShuriken.x = player2.x;
      greninjaShuriken.y = player2.y;
      greninjaShuriken.visible = true;
      greninjaShuriken.velocityX = 12;
    }
    if (keyDown("h") && greninjaShuriken.visible === false && player1.x < player2.x && basic2 > 15) {
    ...
    if (greninjaShuriken.x > 1750 || greninjaShuriken.x < 0) {
      greninjaShuriken.visible = false;
    }
    if (greninjaShuriken.isTouching(player1) && player2.x < player1.x) {
      player1Health = player1Health - 10;
      player1.x = player1.x + 8;
      greninjaShuriken.visible = false;
      greninjaShuriken.x = 0;
      greninjaShuriken.y = 0;
    } else if (greninjaShuriken.isTouching(player1) && player2.x > player1.x) {
      player1Health = player1Health - 10;
      player1.x = player1.x - 8;
      greninjaShuriken.visible = false;
      greninjaShuriken.x = 0;
